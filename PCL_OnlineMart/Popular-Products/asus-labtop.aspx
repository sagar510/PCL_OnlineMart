<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="asus-labtop.aspx.cs" Inherits="PCL_OnlineMart.WebForm7" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    ...
                                    <asp:Button ID="Button2" runat="server" style="padding: 10px 20px;margin-bottom: 30px;" class="btn btn-primary" type="button" Text="Buy Now" OnClick="Button2_Click"/>
                                    </form>
